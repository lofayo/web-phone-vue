<template>
  <div class="content">
    <div class="article_header">
      ...
      <p class="blue_line"></p>
      <p class="release_time">发布日期: 2017 年 6 月 8 日</p>
    </div>
  ...
  <br>• Improve consumer retention and satisfaction 
  <br>• Optimize store productivity and reduce the labor cost
  <br>• Increase sales revenue
  <br>• Fast and intutive check out
<br>
<br>
...
<br>  
<br>  
"We attach great importance to the customers' satisfaction, and Mobile POS allows us to offer personalized and high-standard service to our customers at retail stores. Each of our salespersons is now equipped with a Mobile POS which has successfully eliminated queuing and empowered them to respond to customers' various requests anywhere, anytime on the floor." - CaiJIanren GM of innisfree
Sources from : <a href="https://www.cosmeticsdesign-asia.com/Article/2017/01/18/Innisfree-collaborates-with-POSPi-and-Bank-of-China-to-launch-mobile-payment-in-China">cosmeticsdesign-asia.com/Business-Financial/Innisfree-collaborates-with-POSPi-and-Bank-of-China-to-launch-mobile-payment-in-China</a>
<br>
<br>
  ...
  .content
    ...
    .article_text
      ...
      .img
        ...
        margin: 0.533333rem 0
      .img1
        bg_dpr_jpg('~images/img_article2_img1') 
      .img2
        bg_dpr_jpg('~images/img_article2_img2') 
      .img3
        bg_dpr_jpg('~images/img_article2_img3') 
      .img4
        bg_dpr_jpg('~images/img_article2_img4') 
        height: 11.36rem
      .img5
        bg_dpr_jpg('~images/img_article2_img5') 
        height: 11.36rem
</style>
