  ...
  <div class="content">
    <div class="article_header">
      <p class="article_title">
       Physical Store Will Always Exist
      </p>
      <p class="blue_line"></p>
      <p class="release_time">发布日期: 2017 年 3 月 7 日</p>
    </div>
...
What do consumers expect from staff who are using mobile devices? 
 <br> &nbsp;&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp; 50% of customers expect the ability to immediately check additional store inventory
 <br> &nbsp;&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp; 24% of customers expect to receive the personalized recommendation based on their purchasing history
 <br> &nbsp;&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp; 49% of customers expect to check out and make payment on the go anywhere anytime on the floor
 <br> &nbsp;&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp; Customers queing 5 minuteswill dump their shopping basket
      </p>
      <p class="img img2"></p>
            <p class="img img3">
      </p>
...
“Innisfree, as one of the fastest growing brands under Amorepacific, has inherited the spirit of innovation and achieved a geometric growth over the past 4 years, especially in the Chinese market. The application of Mobile POS allows them to offer a personalized service to the customers at retail stores. Each of salespersons is now equipped with a mobile POS which has successfully eliminated queuing and empowered them to respond to customer’s various requests anywhere, anytime on the floor.”
      ...
      <p class="paragraph">
      What’s stopping you?
Why wait and see? Smart retailers are taking the initiative, embracing the technology, and engaging today’s tech-savvy shoppers by delivering on their hyper-smart shopping expectations. There’s no time like the present. It’s the future of retail.
<br>  <br>  

POSPi
<br>http://pospi.com
<br>About POSPi:
<br>POSPi, headquartered in Shanghai, specializes in the R&D of innovative mobile retail technology solutions to enable retailers to step into future smart retailing era. <br>
  ...
  .content
    ...
    .article_text
      ...
      .img
        ...
        margin: 0.533333rem 0
      .img1
        bg_dpr_jpg('~images/img_article6_img1') 
      .img2
        bg_dpr_jpg('~images/img_article6_img2') 
      .img3
        bg_dpr_jpg('~images/img_article6_img3') 
      .img4
        bg_dpr_jpg('~images/img_article6_img4') 
